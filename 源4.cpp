...
//int main()
//{
//    const cv::Point3d Pt_LU(30.146875, 58.328472, -52.746101),
//        Pt_RU(32.111813, 21.635019, -21.857662),
//        Pt_LD(-17.990685, 55.067204, -52.787201),
//        Pt_RD(-15.654731, 17.870485, -21.434908);
//
...
//    t.at<double>(0, 0) = pPt_LU.x;
//    t.at<double>(1, 0) = pPt_LU.y;
//    t.at<double>(2, 0) = pPt_LU.z;
...
//
//    std::string readDir = "d://OneDrive - Hiroshima University//Doctor Program//Research//3 visualization (not research)//Experiment Task//2024.05.02 AccuracyExperiment//2024.05.11 arrayPts_mOpenCorr_subset192//";
